      ...
      {props.showFlag ? (
        <div className={styles.profile}>
          <div className={styles.profileContent}>
            ...
            <img src="/images/gadgets.webp" alt="ガジェット" />
            <p>　たぬきっつぁんと申します。生まれは青森ですが、小6という中途半端な年齢で東京に来てしまったので出身を聞かれるとちょっと戸惑います。現在文系大学生です。トップのデザインは自分がガジェット好きなのでiPadをモチーフにしています。</p>
            <p>　趣味は写真を撮ること（風景をよく撮ります）、文章を書くこと（noteにガジェットのことなどを書いてます）、ゲームをすること（Switchのゲームをよくやります）、音楽を聴くこと（J-Popやボカロをよく聴きます）などです。</p>
